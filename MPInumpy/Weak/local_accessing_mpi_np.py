...
if __name__ == '__main__':
    ...
    local_iterate_time = iterate(mpi_np_arr, iters=100)
    ...
    if rank == 0:
        ...
        print("mpi_np,local_slice,%d,%d,%.9f" %(n_procs, local_size, local_slice_time))
        print("mpi_np,local_iterate,%d,%d,%.9f" %(n_procs, local_size, local_iterate_time))
