...
echo $HEADER_SCALING > ./Results/results_strong_1_%j_${DATE}.csv
date;
mpiexec -n 1 --map-by node python3 ./mpi_scipy_kmeans.py $1 $2 >> ./Results/results_strong_1_%j_${DATE}.csv
date;
