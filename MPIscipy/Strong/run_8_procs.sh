...
echo $HEADER_SCALING > ./Results/results_strong_8_%j_${DATE}.csv
date;
mpiexec -n 4 --map-by node python3 ./mpi_scipy_kmeans.py $1 $2 >> ./Results/results_strong_8_%j_${DATE}.csv
date;
