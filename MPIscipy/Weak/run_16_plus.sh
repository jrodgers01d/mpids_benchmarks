...
echo $HEADER_SCALING > ./Results/results_weak_16p_${2}_${DATE}.csv
date;
for procs in 16 32 64 128 256 512;do
  mpiexec -n $procs --map-by node python3 ./mpi_scipy_kmeans.py $1 $2 >> ./Results/results_weak_16p_${2}_${DATE}.csv
done
date;
